...
from dicealgoritm import DiceAlgoritm
...
class Dice(pg.sprite.Sprite):
    def __init__(self, start_pos, dice_size, filenames, speed=20):
    ...
    def _resrart(self):
        self.algoritm = DiceAlgoritm()
        self.visible_images = [self.algoritm.rev["top"] - 1]
    ...
    def random_moving(self, x):
        moving = self.algoritm.roll()
        print(moving)
        for i in moving:
            self.move_stack.append([[[True, False, False, False],
                                    [False, True, False, False],
                                    [False, False, True, False],
                                    [False, False, False, True]][i[0]], i[1]])
